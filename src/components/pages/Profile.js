                    ...
                    <div className="text-muted">
                        ...
                        <Row className="mt-5">
                            <Col md={12} className="text-center">
                                <h4>ชื่นชมการเขียนโปรแกรมเมือไหร่ ?</h4>
                                <p>
                                    ก่อนอื่นผมจะเล่าประวัติของผมคร่าวๆให้ฟัง ผมได้คอมพิวเตอร์เครื่องแรกตอนอนุบาล 3 สมัยนั้นยังเป็น Window XP และทำสิ่งที่ผมทำครั้งแรกนั้นก็คือเล่นเกมใช่ครับผมเอามาเล่นเกมเล่นทั้งวันเล่นแบบไม่กินข้าวกินปลา แล้วมารู้แล้วการเขียนโปรแกรมได้ไงละเมื่อตอน ม.1 ผมได้ลองเปิดเซิฟเกมมายคราฟและสิ่งที่เซิฟอื่นๆเขามีก็คือเว็บเติมเงิน ซึ่งผมก็ต้องการเหมือนกันแต่ผมไม่ชอบซื้ออะไรที่สำเร็จรูปมาแล้ว ผมเลยตัดสินใจลองหัดเขียนเว็บไซต์แบบงูปลาใช่เวลาสักพัก ผลปรากฏว่าผมทำมั้นได้นี้แหละครับคือจุดเริ่มต้นของผม
                                </p>
                            </Col>
